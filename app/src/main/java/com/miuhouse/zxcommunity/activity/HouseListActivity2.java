 ...
 */
public class HouseListActivity2 extends BaseActivity implements View.OnClickListener {
...
//            }
    ...
    public void initTitle() {
        ...
        title.setText(tag == Constants.SELL ? "买房" : "租房");
    ...
    public void initView() {
        setContentView(R.layout.activity_houseforsale2);
