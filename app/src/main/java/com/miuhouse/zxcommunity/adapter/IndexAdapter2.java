...
public class IndexAdapter2 extends BaseAdapter {
    ...
    public IndexAdapter2(Activity mContext, List<ZFZBean> mList, String title) {
        super();
...
//                }
                ...
                holder.propertyPrice.setText(String.valueOf(mList.get(position).getAvgPrice()) + "元/平米");
...
//        if (position < size) {
//            holder.tvPriceUnit.setText("元/平米");
//        } else {
