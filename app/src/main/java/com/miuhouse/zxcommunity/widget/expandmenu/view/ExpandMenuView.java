package com.miuhouse.zxcommunity.widget.expandmenu.view;
...
//			line.setBackgroundResource(R.color.cut_line);
			...
			popRootLayout.setBackgroundColor(mContext.getResources().getColor(R.color.background_content));
	...
	private void startAnimation() {
		...
		if (popupWindow == null) {
			...
			popupWindow.setAnimationStyle(R.style.ExpandMenuPopupWindowAnimation);
			popupWindow.setFocusable(false);
			popupWindow.setOutsideTouchable(true);
			popupWindow.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.white_pure)));
		}
