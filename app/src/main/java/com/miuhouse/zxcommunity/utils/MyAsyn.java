...
import com.miuhouse.zxcommunity.bean.PhotoBean;
import com.miuhouse.zxcommunity.bean.Photos;
import com.miuhouse.zxcommunity.http.MyRequest;
...
//    private ProgressFragment progressFragment = ProgressFragment.newInstance();
    ...
    public MyAsyn(Context recordDetailActivity, AsyncResponse mAsyncResPonse, String folder) {
...
//	    // TODO Auto-generated catch block
        ...
        try {
            ...
            L.i("==== uploading offtime "+(System.currentTimeMillis() - start) + "====");
        } catch (Exception e) {
            e.printStackTrace();
        }
            return  returnStr;
